...
// Shared with api/change-password.js and api/investor-claim.js so the two
...
// account claimed via api/investor-claim.js. Used by login (api/data.js) and
...
// markClaimTokenUsed() in api/investor-claim.js's "complete" step consumes it.
